...
exports.run = (Discord, client, message, args) => {
    ...
    if (!kickChannel) return message.channel.send("I can not find the log channel, the user has been kicked. For logs, get the sever admin to make a channel called `logs`.");
